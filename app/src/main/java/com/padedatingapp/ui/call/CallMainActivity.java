...
public class CallMainActivity extends AppCompatActivity
    ...
    private static final String TAG = "simple-multiparty " + CallMainActivity.class.getSimpleName();
...
//            new AppSettingsDialog.Builder(CallMainActivity.this, getString(R.string.rationale_ask_again))
...
//                    .show();
    ...
    private void requestPermissions() {
        ...
        if (EasyPermissions.hasPermissions(this, perms)) {
            mSession = new Session(CallMainActivity.this, OpenTokConfig.API_KEY, OpenTokConfig.SESSION_ID);
    ...
    public void onConnected(Session session) {
        ...
        mPublisher = new Publisher.Builder(CallMainActivity.this).name("publisher").build();
    ...
    public void onStreamReceived(Session session, Stream stream) {
        ...
        final Subscriber subscriber = new Subscriber(CallMainActivity.this, stream);
        mSession.subscribe(subscriber);
        mSubscribers.add(subscriber);
        mSubscriberStreams.put(stream, subscriber);

        int position = mSubscribers.size() - 1;
        int id = getResources().getIdentifier("subscriberview" + (new Integer(position)).toString(), "id", CallMainActivity.this.getPackageName());
        RelativeLayout subscriberViewContainer = (RelativeLayout) findViewById(id);

        subscriber.setStyle(BaseVideoRenderer.STYLE_VIDEO_SCALE, BaseVideoRenderer.STYLE_VIDEO_FILL);
        subscriberViewContainer.addView(subscriber.getView());

        id = getResources().getIdentifier("toggleAudioSubscriber" + (new Integer(position)).toString(), "id", CallMainActivity.this.getPackageName());
