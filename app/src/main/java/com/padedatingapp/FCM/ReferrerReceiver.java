...
//        Controller.setReferrerDate(context.getApplicationContext(), new Date().getTime());
        PadeDatingApp.referrerFriend.setReferrerData(context.getApplicationContext(), (String) extras.get(KEY_REFERRER));
